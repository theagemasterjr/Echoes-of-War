 ...
 * `videoCache`), always with sound: the player clicked to get here, so the
 * browser lets it speak. When the chapter has no `introVideo` (or the file
 * 404s), a styled "coming soon" frame stands in with CONTINUE. SKIP always
 * advances; onEnded advances once. Beat swaps are instant (no transition
 * phase), so this fades itself in.
 */
