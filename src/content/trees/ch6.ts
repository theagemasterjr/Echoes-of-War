...
const tree: ConstraintTree = {
  ...
  nodes: {
    intro: {
      ...
      learningPoints: [{ id: 'p1', text: 'PLACEHOLDER learning point one', cues: ['PLACEHOLDER cue', 'another wording of it'] }],
    ...
    closing: {
      ...
      learningPoints: [{ id: 'p2', text: 'PLACEHOLDER learning point two', cues: ['PLACEHOLDER cue', 'another wording of it'] }],
