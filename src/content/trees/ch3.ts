  ...
  objectives: [
    {
      ...
      keywords: [
        ...
        'why would japan', 'why did it happen', 'why did this happen', 'how did this happen',
        'what led to', 'what started this', 'what was the reason', 'whats the reason',
        ...
        'oil', 'fuel', 'needed oil', 'need oil', 'no oil of their own', 'running out of oil',
        'america stopped selling', 'stopped selling', 'cut them off', 'blockade',
        'embargo', 'sanctions', 'cut off', 'froze', 'frozen', 'froze their money', 'trade',
        ...
        'knock out the fleet', 'stop america', 'get america out of the way',
        'fleet in the way', 'before america could',
      ],
    },
    {
      id: 'obj-target',
      ...
      keywords: [
        ...
        'what did they attack', 'what was attacked', 'where did they attack',
        'pearl harbor', 'pearl harbour', 'the harbor', 'the harbour',
        'fleet', 'pacific fleet', 'the ships', 'ships', 'warships',
        'hit the ships', 'hit the fleet', 'sank the ships', 'sank ships', 'how many ships',
        'battleship', 'battleships', 'battleship row', 'arizona', 'oklahoma', 'nevada',
        'carrier', 'carriers', 'aircraft carrier', 'aircraft carriers',
        'missed the carriers', 'carriers were not there', 'carriers werent there',
        'where were the carriers',
        'planes', 'aircraft', 'airfields', 'sunk', 'sank', 'damage', 'destroyed',
        'torpedo', 'torpedoes', 'bombs fell', 'surprise attack', 'sneak attack',
        'no warning', 'without warning', 'out of nowhere',
        'how many died', 'how many people died', 'who died', 'casualties', 'sailors',
        'the men on the ships', 'the oil tanks', 'dry docks', 'hickam',
        'that sunday', 'sunday morning', '7 december', 'december 7', 'seventh of december',
        'what happened that morning', 'what happened that day', 'what happened here',
      ],
    },
    {
      id: 'obj-america',
      ...
      keywords: [
        ...
        'america in the war', 'america was in the war', 'now america fights',
        'what did america do', 'what will america do', 'what does america do',
        'declare war', 'declared war', 'declaration of war', 'declaration',
        'neutral', 'neutrality', 'stay out of it', 'staying out', 'stayed out',
        'change the war', 'changed the war', 'changes now', 'what changes', 'what happens now',
        'what happened next', 'what happens next', 'after the attack', 'tide', 'turning point',
        'fight back', 'fought back', 'strike back', 'hit back', 'revenge', 'get revenge',
        'roosevelt', 'the president', 'congress', 'infamy', 'day of infamy',
        'everyone signed up', 'signed up', 'joined up', 'enlisted', 'enlist', 'volunteers',
        'volunteered', 'sleeping giant', 'woke up', 'woke the giant',
