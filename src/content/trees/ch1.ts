  ...
  objectives: [
    {
      ...
      keywords: [
        'treaty of versailles', 'versailles', 'versaille', 'versailes',
        'the treaty', 'treaty', 'treaties', 'peace treaty', 'peace deal',
        'end of world war 1', 'end of the first world war', 'after the first world war',
        '1919', 'punished germany', 'punish germany', 'unfair', 'humiliated', 'humiliating',
        'germans angry', 'germans so angry', 'why were germans angry',
      ],
    },
    {
      id: 'obj-germany',
    ...
    },
    {
      ...
      keywords: [
        ...
        'step by step', 'appeasement', 'appease',
    ...
    },
    {
      ...
      keywords: [
        ...
        'attack poland', 'attacked poland', 'attacking poland',
