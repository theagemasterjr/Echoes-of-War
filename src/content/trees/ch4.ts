  ...
  objectives: [
    {
      ...
      keywords: [
        ...
        'oil', 'oil fields', 'oilfields', 'caucasus', 'fuel',
        'stalins name', 'named after stalin', 'stalins city',
    ...
    },
    {
      ...
      keywords: [
        ...
        'house by house', 'street fighting', 'street by street', 'factory', 'factories',
    ...
    },
    {
      ...
      keywords: [
        ...
        'first aid', 'wounded', 'the wounded', 'patients',
        'civilians', 'families', 'children', 'ordinary people', 'people of the city',
        'women', 'girls', 'friends', 'your friends',
        'cost', 'what it cost', 'was it hard', 'were you scared', 'are you scared',
